...
if __name__ == '__main__':
    ...
    for i in range(0,datacleaned.index.values.size):
        id = datacleaned.loc[i,'Customer ID']
        revenue = datacleaned.loc[i,'Sales']
        name = datacleaned.loc[i,'Customer Name']
    ...
    dataCustomer = {
        ...
        'CustomerName': [customers[id].name for id in customers.keys()],
        'CustomerID': [customers[id].id for id in customers.keys()],
        ...
        # 'Revenue' : [customers[id].revenue for id in customers.keys()]
    }
